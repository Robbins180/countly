...
export default function Home() {
  ...
  // Pro Features
  const isPro = false;
  const BOOST_DAY_KEY = "boost.daily.v1";
  const FREE_MAX_ACTIVE = 1;
  const FREE_MAX_PER_DAY = 3;
  ...
  const data = items
    ...
    .filter(
      (m) =>
        !normalizedFilter || m.title.toLowerCase().includes(normalizedFilter),
    )
    .map((item) => {
      ...
      return {
        ...
        days,
        status,
        completionsThisWeek: completionsForThisItem,
      };
    })
  ...
  // Save prefs
  useEffect(() => {
    AsyncStorage.setItem(PREF_SHOW_ARCHIVED, showArchived ? "1" : "0").catch(
      console.error,
    );
  }, [showArchived]);
  ...
  // Load prefs
  useEffect(() => {
    AsyncStorage.multiGet([PREF_SHOW_ARCHIVED, PREF_FILTER])
      .then((entries) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
        ...
        >
          ...
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                categoryFilter === "all" ? theme.primary : theme.border,
              backgroundColor:
                categoryFilter === "all" ? "#1d263b" : "transparent",
            }}
          >
            <Text
              style={{
                color: categoryFilter === "all" ? theme.primary : theme.text,
                fontSize: 13,
              }}
            >
              All
          ...
          {CATEGORIES.map((cat) => (
            <Pressable
              ...
              style={{
                ...
                borderWidth: 1,
                borderColor:
                  categoryFilter === cat.key ? theme.primary : theme.border,
                backgroundColor:
                  categoryFilter === cat.key ? "#1d263b" : "transparent",
                gap: 6,
              }}
            >
              ...
              <Text
                style={{
                  color:
                    categoryFilter === cat.key ? theme.primary : theme.text,
                  fontSize: 13,
                }}
              >
                {cat.label}
      ...
      >
        <Text style={{ color: theme.text, opacity: 0.7, marginRight: 6 }}>
          Sort:
        </Text>
        ...
        <Pressable
          ...
          style={{
            ...
            borderRadius: 999,
            borderWidth: 1,
            borderColor: sortMode === "name" ? theme.primary : theme.border,
            backgroundColor: sortMode === "name" ? "#1d263b" : "transparent",
          }}
        >
          <Text
            style={{ color: sortMode === "name" ? theme.primary : theme.text }}
          >
            Name
          </Text>
        </Pressable>
        ...
        <Pressable
          ...
          style={{
            ...
            borderRadius: 999,
            borderWidth: 1,
            borderColor: sortMode === "due" ? theme.primary : theme.border,
            backgroundColor: sortMode === "due" ? "#1d263b" : "transparent",
          }}
        >
          <Text
            style={{ color: sortMode === "due" ? theme.primary : theme.text }}
          >
            Due soon
          </Text>
        </Pressable>
        ...
        <Pressable
          ...
          style={{
            ...
            borderRadius: 999,
            borderWidth: 1,
            borderColor: showArchived ? theme.primary : theme.border,
      ...
      {data.length === 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            const mult = getMultiplier(boosts, item.id);
            const boostEndsAt =
              boosts.find((b) => b.counterId === item.id)?.endsAt ?? 0;
            const boostMinsLeft =
              mult > 1 && boostEndsAt > Date.now()
                ? Math.max(0, Math.ceil((boostEndsAt - Date.now()) / 60_000))
                : 0;
        ...
        >
          ...
          >
              ...
              {CATEGORIES.map((cat) => (
                <Pressable
                  ...
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor:
                      addCategory === cat.key ? theme.primary : theme.border,
                    backgroundColor:
                      addCategory === cat.key ? "#1d263b" : theme.bg,
                    borderRadius: 999,
                    paddingVertical: 6,
                    paddingHorizontal: 10,
                    gap: 6,
            ...
            >
              ...
              >
                <Text style={{ color: "#c8cbd0", fontWeight: "700" }}>
                  Cancel
                </Text>
              </Pressable>
        ...
        >
          ...
          >
            ...
            <Text style={{ color: "#9aa0a6", marginBottom: 8 }}>
              Long-press to select and copy. This includes all counters
              (archived too).
            </Text>
        ...
        >
          ...
          >
            ...
            <Text style={{ color: "#9aa0a6", marginBottom: 16 }}>
              {completeItem
                ? `This will set “${completeItem.title}” to 0 days.`
                : ""}
            </Text>
            ...
            >
              ...
              >
                <Text style={{ color: "#9DFFB0", fontWeight: "800" }}>
                  Mark as Complete
                </Text>
              </Pressable>
            </View>
          ...
          >
              ...
              {CATEGORIES.map((cat) => (
                <Pressable
                  ...
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor:
                      editCategory === cat.key ? theme.primary : theme.border,
                    backgroundColor:
                      editCategory === cat.key ? "#1d263b" : theme.bg,
                    borderRadius: 999,
                    paddingVertical: 6,
                    paddingHorizontal: 10,
                    gap: 6,
            ...
            >
              ...
              >
                <Text
                  style={{
                    color: editing?.archived ? "#9DFFB0" : "#F3E38A",
                    fontWeight: "700",
                  }}
                >
              ...
              >
                <Text style={{ color: "#cfe1ff", fontWeight: "700" }}>
                  Duplicate
                </Text>
              </Pressable>
